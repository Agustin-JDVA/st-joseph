    ...
    >
      ...
      <div className="share-top">
        ...
        <div className="share-left-top">
          ...
          <p className="mt-[3px] font-[family:var(--font-wix)] text-[10px] font-normal leading-[1.2] tracking-[-0.01em] text-black sm:text-[11px] lg:text-[12px]">
        ...
        <div className="share-right-top">
          <h3 className="font-[family:var(--font-wix)] text-[16px] font-bold leading-[1.15] tracking-[-0.02em] text-black sm:text-[17px] lg:text-[20px]">
        ...
        <div className="share-left-bottom">
          <h2 className="font-[family:var(--font-wix)] text-[19px] font-bold uppercase leading-none tracking-[-0.025em] text-black sm:text-[21px] lg:text-[23px]">
            JDVA
          </h2>

          <p className="mt-[4px] font-[family:var(--font-wix)] text-[10px] font-normal leading-none tracking-[-0.01em] text-black sm:text-[11px] lg:text-[12px]">
            ¡Conocenos!
          </p>
        </div>
        ...
        <div className="share-right-bottom">
          <div className="flex w-full flex-col gap-[7px]">
            ...
            >
              <span>SITIO WEB</span>
              <span className="jdva-action-arrow">↗</span>
            </a>
      ...
      <style jsx global>{`
        ...
        /*
          TODO EL CONTENIDO DEL BLOQUE BLANCO
          SE SUBE LA MISMA DISTANCIA
        */
